...
namespace EcoRewards.Controllers
{
    public class MaterialTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaterialTypeId,Name,Description,IsActive,PointsPerKg,CO2PerKg")] MaterialType materialType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaterialTypeId,Name,Description,IsActive,PointsPerKg,CO2PerKg")] MaterialType materialType)
        {
            if (ModelState.IsValid)
            {
